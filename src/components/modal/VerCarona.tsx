  ...
  async function procurarCarona() {
    ...
    try {
      await buscar(
        "/viagens",
        (dados: any[]) => {
          const viagemEncontrada = dados.find(
            (viagem) =>
      ...
      <div className="bg-[oklch(20.20%_0.051_277.68)] border border-slate-700 rounded-2xl w-full max-w-lg shadow-2xl overflow-y-auto max-h-[90vh]">
        ...
        <div className="p-6 space-y-4">
          ...
          <button
            ...
            className="w-full bg-[oklch(53.13%_0.202_277.03)] hover:bg-[oklch(64.35%_0.151_281.28)] text-white py-4 rounded-xl font-bold transition"
          >
            Buscar
          </button>
