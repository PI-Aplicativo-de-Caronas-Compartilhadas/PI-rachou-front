...
import DeletarModalidade from "../deletarmodalidade/DeletarModalidade";
...
function CardModalidade({ modalidade, atualizarLista }: CardModalidadeProps) {
   
    return (
        <div
            className="flex flex-col w-[92vw] xs:w-full max-w-sm rounded-2xl border border-ultrasonic-blue-600 bg-ultrasonic-blue-800
        ...
        >
            ...
            <div className="mt-4 flex justify-end gap-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-ultrasonic-blue-600 text-white transition hover:bg-ultrasonic-blue-500">
                    <ModalModalidade
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-red-500 text-white transition hover:bg-red-600">
                    <ModalModalidade
