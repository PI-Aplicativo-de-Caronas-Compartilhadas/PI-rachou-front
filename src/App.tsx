import React from 'react'; // Linha adicionada para resolver o erro de JSX do TypeScript
...
import EditarPerfil from "./components/navbar/editarperfil/EditarPerfil";
